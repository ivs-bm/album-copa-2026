...
const MATCHES = [
  ...
  // Semi-Final
  { id: 'wc-101', date: '14/07 - 16:00', teamA: 'FRA', teamB: 'ESP', stage: 'knockout', status: 'pending' },
  { id: 'wc-102', date: '15/07 - 16:00', teamA: 'ENG', teamB: 'ARG', stage: 'knockout', status: 'pending' },
